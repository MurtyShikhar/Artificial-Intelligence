...
#include <iterator>
#include <ctime>
#include "matchingCost2.h"


using namespace std;


#define numLongerChild 10 // number of longer children
#define numShorterChild 10 // number of shorter children
#define probability 200	// probability of accepting a bad Move == 1/1000
#define plateauMoves 20
#define TOLERANCE 10
...
vector<string> input(ifstream& f)
{
    ...
    char hash;
    f >> hash;
    m.initialize(costMatrix,charMap, CC);
    
    
    return sequences;
}

//////////////////////////////////////////// Code for handling IO //////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////// CODE FOR RANDOM HILL CLIMBING ALGORITHM /////////////////////////////////////////////////////////////////////////
...
vector<string> perturbBlockExchange(vector<string>& s, int maxSize)
{
    ...
    for (int i = 0; i < numLongerChild; i++)
    ...
    if (s[0].size() > maxSize)
    {  for (int i = 0; i < numShorterChild; i++)
    ...
    //if (newChildren[min][0].size() != s[0].size())
        //printf("%s\n", "gotcha");
...
vector<string> hillClimbing(vector<string>& s,vector<string>& start, int iterations, int pM = plateauMoves)
{
    typedef vector<string> state;
    bestSofar = start;
